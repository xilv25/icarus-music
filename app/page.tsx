    ...
    <div className="flex h-screen bg-black text-white overflow-hidden font-sans">
      ...
      <div className="flex-1 bg-gradient-to-b from-[#1f1f1f] to-[#121212] rounded-lg m-2 flex flex-col relative overflow-y-auto">
        ...
        <div className="sticky top-0 bg-[#121212]/70 backdrop-blur-md px-6 py-4 flex items-center justify-between z-10">
          ...
          <div className="hidden md:flex items-center gap-3">
             <div className="w-9 h-9 bg-[#242424] rounded-full flex items-center justify-center hover:scale-105 transition cursor-pointer">
        ...
        <div className="p-6 pb-28">
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
              {songs.map((song, idx) => (
                <div key={idx} className="bg-[#181818] p-4 rounded-xl hover:bg-[#282828] transition group flex flex-col cursor-pointer shadow-lg">
      ...
      <div className="absolute bottom-0 w-full h-24 bg-black border-t border-[#282828] px-4 flex items-center justify-between z-50">
        ...
        <div className="flex items-center gap-4 w-1/3 min-w-[180px]">
          ...
          <div>
            <div className="text-sm font-semibold text-white hover:underline cursor-pointer truncate">Select a track</div>
            <div className="text-xs text-gray-400 hover:underline cursor-pointer truncate">Icarus Music</div>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center justify-center w-1/3 max-w-[722px] gap-2">
          <div className="flex items-center gap-6">
            ...
            <div className="w-8 h-8 bg-white rounded-full flex items-center justify-center hover:scale-105 transition cursor-pointer">
          ...
          <div className="w-full flex items-center gap-2 group">
            ...
            <div className="h-1 bg-[#4d4d4d] rounded-full flex-1 relative cursor-pointer">
              ...
              <div className="absolute top-1/2 -translate-y-1/2 left-0 w-3 h-3 bg-white rounded-full opacity-0 group-hover:opacity-100 shadow"></div>
            </div>
